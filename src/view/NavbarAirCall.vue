    ...
    <section class="">
      <div class="parentNavbar">
        ...
        <div class="divDropdown ">
          ...
          <div class="divButton">
          <div class="btnStyle">
            <button class="btnStyle_txt1">Demandez une démo </button>
          </div>
          <div class="btnStyle">
            <button class="btnStyle_txt2">
              Essai gratuit
            </button>
          </div>
        </div>
...
.navStyle{
  ...
  border-bottom: solid 0.5px #eaebf0;
}
.paddingZero {
  padding: 0px;
}
...
.parentNavbar {
  display: grid;
  grid-template-columns: repeat(2, 1fr) 2.5fr 2fr 0.5fr;
